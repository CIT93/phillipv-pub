Initail Error run: numberReps < 10 if number of reps is less than 10, the error will prompt that an individual needs to do more than 9 to look like Captain America. Line 6-8 
